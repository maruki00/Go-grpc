...
/*
Package orders_order is a reverse proxy.
...
func RegisterOrdersHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OrdersServer) error {
	mux.Handle(http.MethodPost, pattern_Orders_AddOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/.Orders/AddOrder", runtime.WithHTTPPathPattern("/Orders/AddOrder"))
		if err != nil {
...
func RegisterOrdersHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OrdersClient) error {
	mux.Handle(http.MethodPost, pattern_Orders_AddOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/.Orders/AddOrder", runtime.WithHTTPPathPattern("/Orders/AddOrder"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Orders_AddOrder_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"Orders", "AddOrder"}, ""))
)
